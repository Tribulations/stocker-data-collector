...
COMMENT ON COLUMN stock_prices_schema.stock_prices_1day.timestamp IS 'Unix timestamp marking the start of the candlestick interval';
...
COMMENT ON COLUMN stock_prices_schema.stock_prices_1day.low IS 'Lowest price during interval';
COMMENT ON COLUMN stock_prices_schema.stock_prices_1day.high IS 'Highest price during interval';
